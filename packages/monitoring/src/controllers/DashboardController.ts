// packages/monitoring/src/controllers/DashboardController.ts
...
export class DashboardController {
  ...
  static async getRecentAlerts(req: Request, res: Response): Promise<Response> {
    try {
  ...
  static async getDailyStats(_req: Request, res: Response): Promise<Response> {
    try {
  ...
  static async testServiceConnection(
    ...
    try {
      ...
      const result = await DashboardService.testServiceConnection(serviceName);
      return res.status(result.success ? 200 : 400).json(result);
    } catch (error) {
      return res.status(500).json({
        success: false,
  ...
  static async getServiceDetails(
    ...
    try {
      ...
      const result = await DashboardService.getServiceDetails(serviceName);
      return res.status(result.success ? 200 : 400).json(result);
    } catch (error) {
      return res.status(500).json({
        success: false,
